...
[ !`which java` ] && echo '"cordova" failed' >> log.txt && return

ANDROID_SDK_TOOLS_VERSION=$1    # '4333796'
ANDROID_PLATFORM_VERSION=$2     # 'platforms;android-28'
ANDROID_BUILD_TOOLS_VERSION=$3  # 'build-tools;28.0.3'
ANDROID_SYSTEM_IMAGE_VERSION=$4 # 'system-images;android-28;google_apis;x86_64'
ANDROID_AVD_NAME=$5             # 'test'
